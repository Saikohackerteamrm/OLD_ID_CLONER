...
____________________
    ...
    $ git clone https://github.com/Saikohackerteamrm/OLD_ID_CLONER
    $ cd OLD_ID_CLONER
    $ python S-H-T.py
...
_______________________________________
    ...
    apt update -y && apt upgrade -y && pkg install git -y && pkg install python -y  && git clone https://github.com/Saikohackerteamrm/OLD_ID_CLONER && cd OLD_ID_CLONER && python S-H-T.py
 ### Hi there 👋
